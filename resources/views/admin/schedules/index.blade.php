    ...
    <div class="app-shell">
        <aside class="sidebar">
            ...
            <nav class="nav-section">
                ...
                <a class="nav-link active" href="{{ route('admin.schedules.index') }}">📅 Jadwal</a>
        ...
        <main class="content">
            <div class="topbar">
                <div class="fw-semibold">Jadwal Latihan</div>
            ...
            <div class="main-panel">
                <div class="panel header-panel mb-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <p class="text-uppercase text-muted small mb-1">Training plan</p>
                            <h2 class="mb-0">Jadwal Latihan</h2>
                        </div>
                        <a href="{{ route('admin.schedules.create') }}" class="btn primary-btn text-white">Tambah Jadwal</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-4">Belum ada jadwal latihan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
